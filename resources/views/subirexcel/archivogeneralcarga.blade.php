        ...
        <div class="section-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="text-center">Subir archivo de carga completo</h3>
                            @if($errors->any())
                            ...
                            @endif
                            <form action="{{ route('enviarexcelocg') }}" method="POST" class="formulario-oc" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="excel"><h3>Selecciona el archivo excel a subir.</h3></label>
                                    <br />
                                    <input type="file" name="excelocg" id="excelocg" class="upload-box">
                                </div>
